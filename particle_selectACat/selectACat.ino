...
const int deterrentDevice = D2;
const int foodDispensorPin = D3;
const int weighCorrectCatPin = D4;
const int dispensorAtTopPin = D5;
const int reservoirLowLED = D6;

const int thereIsACatPin = D1;
...
// from gist.github.com/technobly/349a916fb2cdeb372b5e
